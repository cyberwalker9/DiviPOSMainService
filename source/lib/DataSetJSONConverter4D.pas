  ...
  begin
    ...
    begin
      ...
      case pDataSet.Fields[I].DataType of
        ...
        TFieldType.ftInteger, TFieldType.ftByte, TFieldType.ftSmallint, TFieldType.ftShortint:
          Result.AddPair(vKey, TJSONNumber.Create(pDataSet.Fields[I].AsInteger));
        TFieldType.ftLargeint, TFieldType.ftLongWord:
          begin
        ...
        TFieldType.ftString, ftWideString, ftMemo, ftWideMemo:
        ...
        raise EDataSetJSONConverterException.CreateFmt('Cannot find type for field "%s" %d', [vKey, ord(pDataSet.Fields[I].DataType)]);
      end;
    end;
  end;
end;
